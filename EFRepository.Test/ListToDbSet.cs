...
namespace EFRepository.Test
{
    public static class ListToDbSet
    {
        ...
        public static IDbSet<T> Initialize<T>(this IDbSet<T> dbSet, IQueryable<T> data) where T : class
        {
            ...
            //Taken from https://stackoverflow.com/questions/21069986/nsubstitute-dbset-iqueryablet
        ...
        //Taken from https://docs.microsoft.com/en-gb/ef/ef6/fundamentals/testing/mocking#async
